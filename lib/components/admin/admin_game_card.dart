...
import 'package:lob_app/components/admin/delete_game_sheet.dart';
import 'package:lob_app/models/schedule.dart';
import 'package:lob_app/pages/admin/add_game_score.dart';
import 'package:lob_app/providers/logos_provider.dart';

class AdminGameCard extends ConsumerWidget {
  final Game game;
  final int season;
  AdminGameCard({super.key, required this.game, required this.season});
